...
col_palette <- c(nord("frost")[2], #lightblue1
                 nord("aurora")[3], #yellow2
                 nord("frost")[4], #darkblue3
                 nord("aurora")[2], #orange4
                 nord("moose_pond")[6], #darkyellow5
                 nord("lumina")[2], #pink6
                 nord("aurora")[1], #red7
                 nord("halifax_harbor")[5]) #purple8
...
ggsave("figures/Fig3a.pdf", Fst_heat, height = 16.5, width = 21, units = "cm")
...
ggsave("figures/Fig3b_1.pdf", ibd_plot, height = 16.5, width = 21, units = "cm")
ggsave("figures/Fig3b_2.pdf", ibd_plot_curve, height = 16.5, width = 21, units = "cm")
