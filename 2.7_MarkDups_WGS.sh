...
INPUT_DIR=/exports/cmvm/eddie/eb/groups/ogden_grp/marc/WBD_reseq_2022/data/out/bwa/RG_bams
OUTPUT_DIR=/exports/cmvm/eddie/eb/groups/ogden_grp/marc/WBD_reseq_2022/data/out/bwa/markedDups

# Get list of files in target directory

bam=$(ls -1 ${INPUT_DIR}/*RG.bam)
